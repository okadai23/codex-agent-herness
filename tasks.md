...
### T01-01: Copier templateの基本構成を作成する
...
### T01-02: `ts-fullstack` profileを実装する
...
### T01-03: `python-ai-service` profileを実装する
...
### T01-04: `hybrid-product` profileを実装する
...
### T01-05: Copier update flowを検証する
...
### T03-01: `standardctl doctor` を実装する
...
### T03-02: `standardctl drift` を実装する
...
### T03-03: `standardctl apply --section` を実装する
...
### T03-04: `standardctl update-template` を実装する
...
### T03-05: `standardctl update-harness` を実装する
