...
- [DONE] [Docs] 各APM Packageのメンテナンス/適用ガイドを追加
  - `docs/package-maintenance-and-apply-guide.md` を新規作成し、packageごとの責務・適用先・運用手順を整理
  - 新規導入/既存repo段階適用/更新運用/トラブルシュートを1ドキュメントに統合
  - `README.md` にガイドへの導線を追加
